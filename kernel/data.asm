...
kernel_idt_exception_string_unknwon db STATIC_ASCII_NEW_LINE, "{UNKNOWN CPU EXCEPTION}", STATIC_ASCII_TERMINATOR
...
kernel_idt_exception_string_bound_range_exceeded db STATIC_ASCII_NEW_LINE, "Bound Range Exceeded", " at 0x", STATIC_ASCII_TERMINATOR
...
kernel_idt_exception_string_invalid_tss db STATIC_ASCII_NEW_LINE, "Coprocessor Segment Overrun", " at 0x", STATIC_ASCII_TERMINATOR
